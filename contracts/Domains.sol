...
contract Domains is ERC721URIStorage {
  ...
  function register(string calldata name) public payable {
      ...
      abi.encodePacked(
          '{"name": "',
          _name,
          '", "description": "A domain on the Hacker Name Service", "image": "data:image/svg+xml;base64,',
      ...
      // sets the NFT fata -- JSON blob w/our domain's info!
      _setTokenURI(newRecordId, finalTokenUri);
      domains[name] = msg.sender;

      console.log("%s has claimed %s.%s", msg.sender, name, tld);
